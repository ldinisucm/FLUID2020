...
P=[0.2  .2 .2
   .4   .4 .4
   .4   .4 .4]; %This is actually UNCORRELATED: just to use the same program
...
num_races=50; %number of races   

%initialize variables
%S(1)=0; %initial (log) capital
S=zeros(1,num_races); %initial (log) capital
