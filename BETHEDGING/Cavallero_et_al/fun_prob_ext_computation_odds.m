function Pext=fun_prob_ext_computation_odds(p,odds,threshold,num_pasos)
logC0=0;
tray=[0;1];
%num_pasos=14
%p=.6;
...
delta_0=log(b(1)*odds(2)); %Because of the way P and b are defined here!
delta_1=log(b(2)*odds(1));
