...
int_tau=Dtau*sum(tau.^(-x).*real((j*w*tau*(1+G2/G0)+G2/G0-tau*tau2*G2/G0*w^2)./(1+j*w*(tau-taub)-tau*tau2*w^2-j*tau3*tau*w^3)));
gpp(i)=G0*Dtau*sum(tau.^(-x).*imag((j*w*tau*(1+G2/G0)+G2/G0-tau*tau2*G2/G0*w^2)./(1+j*w*(tau-taub)-tau*tau2*w^2-j*tau3*tau*w^3)))+eta0*(w);
