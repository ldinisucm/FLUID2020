function [wloss,gprime_tiempo,gpp_tiempo]=datos_exp_fun(condicion,tiempo)
nada=0
...
%loglog(welast,gprime_tiempo,'ro','MarkerFaceColor','r')
loglog(welast,gprime_tiempo,'o')
hold on
wloss=B(:,1);
gpp_tiempo=B(:,tiempo);
%gpp_96=10.^B(:,);
%loglog(wloss,gpp_tiempo,'ro','MarkerFaceColor','w')
...
ylabel('G')
%figure(2)
%loglog(wloss,gprime_tiempo./gpp_tiempo)
%hold on
end
