...
int_tau=Dtau*sum(tau.^(-x).*real(j*w*tau./(1+j*w*tau/(1+j*w*tau2)+w^4*tau*tau3^3-j*w^3*tau*tau4^2)));
gpp(i)=G0*Dtau*sum(tau.^(-x).*imag(j*w*tau./(1+j*w*tau/(1+j*w*tau2)+w^4*tau*tau3^3-j*w^3*tau*tau4^2)))+eta0*(w);
